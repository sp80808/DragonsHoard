...
export const RunSummary: React.FC<Props> = ({ gameState, onRestart, onShowLeaderboard, onHome }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-hidden">
      ...
      {/* Main Card Container */}
      <div className="relative w-full max-w-5xl bg-[#08080a] border border-red-900/30 rounded-3xl shadow-[0_0_100px_rgba(220,20,60,0.2)] overflow-hidden animate-in zoom-in-95 duration-500 flex flex-col md:flex-row h-auto max-h-[90vh]">
        ...
        <div className="w-full md:w-7/12 p-6 md:p-8 flex flex-col relative bg-[url('https://www.transparenttextures.com/patterns/dark-matter.png')] overflow-y-auto custom-scrollbar">
           ...
           <div className="relative z-10 flex flex-col h-full items-center text-center">
              ...
              {/* Header */}
              <div className="mb-6 animate-in slide-in-from-top-8 duration-700 w-full">
                  <Skull size={64} className="text-red-600 mx-auto mb-3 drop-shadow-[0_0_25px_rgba(220,38,38,0.8)] animate-pulse" />
                  ...
                  <div className="h-px w-24 bg-red-900/50 mx-auto mt-4 mb-2"></div>
                  <p className="text-red-400/60 font-serif italic text-xs tracking-[0.3em] uppercase">
        ...
        <div className="w-full md:w-5/12 bg-slate-950 border-t md:border-t-0 md:border-l border-red-900/30 relative flex flex-col overflow-y-auto custom-scrollbar">
            ...
            <div className="relative z-10 flex-1 p-8 flex flex-col justify-start">
